...
function App() {
  ...
  const onClearFB = () => {
    dispatch("clearFB", handleResponse);
  };

  const onRemoveAds = () => {
    dispatch("removeAds", handleResponse);
  };

  const isFacebook = () => {
    return info?.url?.indexOf("facebook") >= 0;
  };

  const CleanSvg = () => (
    <svg width="1em" height="1em" fill="currentColor" viewBox="0 0 1024 1024">
      <path
        d="M662.688,13.546L491.347,345.754c0.983,0.276,1.964,0.569,2.938,0.883c7.235,2.33,14.028,5.17,20.353,8.499
      ...
      />
      <path
        d="M96.597,629.659c27.24,24.567,60.687,45.974,99.412,63.623c65.396,29.808,122.948,38.61,125.365,38.971
